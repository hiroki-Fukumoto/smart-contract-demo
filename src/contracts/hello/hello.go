...
var HelloMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
//
// Solidity: function HelloWorld() pure returns(string)
func (_Hello *HelloCaller) HelloWorld(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Hello.contract.Call(opts, &out, "HelloWorld")
...
//
// Solidity: function HelloWorld() pure returns(string)
func (_Hello *HelloSession) HelloWorld() (string, error) {
	return _Hello.Contract.HelloWorld(&_Hello.CallOpts)
}

// HelloWorld is a free data retrieval call binding the contract method 0x7fffb7bd.
//
// Solidity: function HelloWorld() pure returns(string)
func (_Hello *HelloCallerSession) HelloWorld() (string, error) {
	return _Hello.Contract.HelloWorld(&_Hello.CallOpts)
}
